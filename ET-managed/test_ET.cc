...
/* Template specialization */
  ...
  //void operator() (const unsigned int ss, const Lattice<obj> &arg) const{
  //   return arg._odata[ss];
  // }
  struct evalfunc1{
  inline obj eval(const unsigned int ss, const Lattice<obj> &arg)
  ...
  //KOKKOS_INLINE_FUNCTION
  // void operator() (const unsigned int ss, const LatticeBinaryExpression<Op, T1,T2> &expr) const{
  //      return expr.Op.func(eval(ss, expr.arg1), eval(ss, expr.arg2));
  //   }
  // evalfunc1<int> eval1; 
   auto inline eval (const unsigned int ss, const LatticeBinaryExpression<Op,T1,T2> &expr) 
    -> decltype(expr.Op.func(eval1.eval(ss,expr.arg1),eval1.eval(ss,expr.arg2)))
   {  
    return expr.Op.func(eval1.eval(ss,expr.arg1),eval1.eval(ss,expr.arg2));
   }
...
#define BINOP(name)  name<decltype(eval2.eval(0, lhs)), decltype(eval2.eval(0, rhs))>
